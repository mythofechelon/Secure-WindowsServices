...
.NOTES
	...
	Changes in v1.11 (2021/10/13 21:48):    Changed detection of security principals from English string matching to SID matching to facilitate usage in non-English environments.
