...
.NOTES
	...
	Version:                                1.13
	Changes in v1.13 (2021/10/16 14:45):    Added parameter "Services"; tweaked warning message; added Info output of new image path:45.
...
Function Secure-WindowsServices {
	...
	Process {
		Try {
			...
			Write-Host "Securing Windows services...";
			Write-Host "";
